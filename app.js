...
const defaultPhrases = [
    ...
    { text: "אני צריכה עזרה", label: "עזרה", category: "needs", icon: "fa-handshake-angle" },
    { text: "אני רעבה", label: "אני רעבה", category: "needs", icon: "fa-utensils" },
    { text: "אני צמאה", label: "אני צמאה", category: "needs", icon: "fa-glass-water" },
    { text: "אני צריכה ללכת לשירותים", label: "שירותים", category: "needs", icon: "fa-restroom" },
    { text: "אני עייפה ורוצה לישון", label: "עייפה / לישון", category: "needs", icon: "fa-bed" },
    ...
    { text: "אני מרגישה טוב", label: "שמחה", category: "feelings", icon: "fa-face-smile" },
    { text: "משהו כואב לי", label: "כואב לי", category: "feelings", icon: "fa-face-sad-tear" },
    { text: "אני מרגישה לא טוב", label: "חולה", category: "feelings", icon: "fa-face-thermometer" },
    { text: "הכל בסדר", label: "הכל בסדר", category: "feelings", icon: "fa-thumbs-up" },
    { text: "אני כועסת", label: "כועסת", category: "feelings", icon: "fa-face-angry" },
    { text: "אני עצובה", label: "עצובה", category: "feelings", icon: "fa-face-frown" },
    { text: "אני מפחדת", label: "מפחדת", category: "feelings", icon: "fa-face-flushed" },
    { text: "אני נרגשת", label: "נרגשת", category: "feelings", icon: "fa-face-laugh-beam" },
    { text: "אני משועממת", label: "משועממת", category: "feelings", icon: "fa-face-meh" },
    { text: "אני רגועה", label: "רגועה", category: "feelings", icon: "fa-spa" },
    ...
    { text: "אני רוצה ללכת לפארק טרמפולינות", label: "פארק טרמפולינות", category: "games", icon: "fa-child-reaching" }
];
